...
<body>
  <div class="navbar navbar-expand-lg navbar-dark bg-dark container-fluid">
    <div class="container">
      <a class="navbar-brand" id="logo" href="http://localhost/cinema/cinemaV2/index.php"><img src="http://localhost/cinema/cinemaV2/img/logo.png"></img></a>
      <div class="container row justify-content-center" id="navbarColor02">
        <form class="d-flex form-inline my-2 my-lg-0 col-4">
          <input class="form-control" type="text" placeholder="Search">
          <button class="btn btn-secondary my-2 my-sm-0" type="submit">Search</button>
        </form>
      </div>
      <a class="d-flex btn btn-danger col-2" href="index.php?action=login">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-danger">
    <ul class="navbar-nav mr-auto container">
      ...
      <li class="nav-item">
        <a class="nav-link" href="index.php?action=listPics">affiches</a>
      </li>
      <li class="nav-item">
